...
import { deleteByIds, page } from '~/emergency/api/TacceptJtdb.ts'
...
defineOptions({ name: 'emergency:taccept_jtdb' })
  ...
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-if="false"
          v-auth="['emergency:taccept_jtdb:create']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-if="false"
          v-auth="['emergency:taccept_jtdb:delete']"
          type="danger"
          plain
      ...
      <template #empty>
        <el-empty>
          <el-button
            v-auth="['emergency:taccept_jtdb:save']"
            type="primary"
            @click="() => {
              maDialog.setTitle(t('crud.add'))
              maDialog.open({ formType: 'add' })
