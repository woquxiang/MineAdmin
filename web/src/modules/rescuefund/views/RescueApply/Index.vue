...
import { deleteByIds, page } from '~/rescuefund/api/RescueApply.ts'
...
defineOptions({ name: 'rescuefund:rescue_apply' })
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['rescuefund:rescue_apply:create']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['rescuefund:rescue_apply:delete']"
          type="danger"
          plain
      ...
      <template #empty>
        <el-empty>
          <el-button
            v-auth="['rescuefund:rescue_apply:save']"
            type="primary"
            @click="() => {
              maDialog.setTitle(t('crud.add'))
              maDialog.open({ formType: 'add' })
