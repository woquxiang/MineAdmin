...
import { deleteByIds, page } from '~/injury/api/InjuryClaimApplication.ts'
...
defineOptions({ name: 'injury:injury_claim_application' })
  ...
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
                  ...
                  <el-button
                    v-auth="['injury:injury_claim_application:create']"
                    type="danger"
                    @click="() =>router.push({'path':'/injury/save/add'}) "
                  >
                    {{ t('crud.add') }}
                  </el-button>
      </template>
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['injury:injury_claim_application:delete']"
          type="danger"
          plain
      ...
      <template #empty>
        <el-empty>
          <el-button
            v-auth="['injury:injury_claim_application:save']"
            type="primary"
            @click="() => {
