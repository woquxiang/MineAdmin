...
import { deleteByIds, page } from '~/injury/api/InjuryPartyInformation.ts'
...
defineOptions({ name: 'injury:injury_party_information' })
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['injury:injury_party_information:save']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['injury:injury_party_information:delete']"
          type="danger"
          plain
