...
import { deleteByIds, page } from '~/healthcare/api/HospitalVisits.ts'
...
defineOptions({ name: 'healthcare:hospital_visits' })
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['healthcare:hospital_visits:save']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['healthcare:hospital_visits:delete']"
          type="danger"
          plain
