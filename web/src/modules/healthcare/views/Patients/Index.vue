...
import { deleteByIds, page } from '~/healthcare/api/Patients.ts'
...
defineOptions({ name: 'healthcare:patients' })
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['healthcare:patients:save']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['healthcare:patients:delete']"
          type="danger"
          plain
