...
import { deleteByIds, page } from '~/healthcare/api/MedicalExpenses.ts'
...
defineOptions({ name: 'healthcare:medical_expenses' })
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['healthcare:medical_expenses:save']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['healthcare:medical_expenses:delete']"
          type="danger"
          plain
