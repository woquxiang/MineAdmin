...
import { deleteByIds, page } from '~/healthcare/api/TrafficIncidents.ts'
...
defineOptions({ name: 'healthcare:traffic_incidents' })
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['healthcare:traffic_incidents:save']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['healthcare:traffic_incidents:delete']"
          type="danger"
          plain
