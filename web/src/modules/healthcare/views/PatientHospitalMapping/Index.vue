...
import { deleteByIds, page } from '~/healthcare/api/PatientHospitalMapping.ts'
...
defineOptions({ name: 'healthcare:patient_hospital_mapping' })
...
<template>
  <div class="mine-layout pt-3">
    <MaProTable ref="proTableRef" :options="options" :schema="schema">
      <template #actions>
        <el-button
          v-auth="['healthcare:patient_hospital_mapping:save']"
          type="primary"
          @click="() => {
      ...
      <template #toolbarLeft>
        <el-button
          v-auth="['healthcare:patient_hospital_mapping:delete']"
          type="danger"
          plain
